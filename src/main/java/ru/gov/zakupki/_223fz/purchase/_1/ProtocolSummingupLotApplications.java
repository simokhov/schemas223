...
/**
 * Заявки и требования к составу документов по лоту
 * 
 * <p>Java class for protocolSummingupLotApplications complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="protocolSummingupLotApplications">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="lot" type="{http://zakupki.gov.ru/223fz/purchase/1}protocolLotType"/>
 *         &lt;element name="application" type="{http://zakupki.gov.ru/223fz/purchase/1}protocolSummingupApplicationType" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "protocolSummingupLotApplications", propOrder = {
    "lot",
    "application",
    "documentsRequirement"
})
public class ProtocolSummingupLotApplications {

    @XmlElement(required = true)
    protected ProtocolLotType lot;
    protected List<ProtocolSummingupApplicationType> application;
     ...
     * {@link ProtocolSummingupApplicationType }
     * 
     * 
     */
    public List<ProtocolSummingupApplicationType> getApplication() {
        if (application == null) {
            application = new ArrayList<ProtocolSummingupApplicationType>();
        }
