...
/**
 * Заявка конкурса в электронной форме, участниками которого могут быть только субъекты малого и среднего предпринимательства
 * 
 * <p>Java class for protocolRZ1KESMBOApplicationType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="protocolRZ1KESMBOApplicationType">
 *   &lt;complexContent>
...
@XmlType(name = "protocolRZ1KESMBOApplicationType", propOrder = {
    "applicationNumber",
    "applicationDate",
    "accepted",
    "rejectionReason",
...
public class ProtocolRZ1KESMBOApplicationType {
