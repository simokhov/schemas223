...
/**
 * Рассмотрение первых частей заявок для конкурса в электронной форме, участниками которого могут быть только субъекты малого и среднего предпринимательства по лоту
 * 
 * <p>Java class for protocolRZ1KESMBOLotApplications complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="protocolRZ1KESMBOLotApplications">
 *   &lt;complexContent>
 ...
 *         &lt;element name="application" type="{http://zakupki.gov.ru/223fz/purchase/1}protocolRZ1KESMBOApplicationType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "protocolRZ1KESMBOLotApplications", propOrder = {
    "guid",
    "ordinalNumber",
    "subject",
...
public class ProtocolRZ1KESMBOLotApplications {
    ...
    protected List<ProtocolRZ1KESMBOApplicationType> application;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ProtocolRZ1KESMBOApplicationType }
     * 
     * 
     */
    public List<ProtocolRZ1KESMBOApplicationType> getApplication() {
        if (application == null) {
            application = new ArrayList<ProtocolRZ1KESMBOApplicationType>();
        }
