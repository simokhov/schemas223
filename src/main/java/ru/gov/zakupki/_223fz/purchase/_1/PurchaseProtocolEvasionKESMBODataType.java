...
/**
 * Протокол признания участника уклонившимся от заключения договора конкурса в электронной форме, участниками которого могут являться только субъекты малого и среднего предпринимательства
 * 
 * <p>Java class for purchaseProtocolEvasionKESMBODataType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="purchaseProtocolEvasionKESMBODataType">
 *   &lt;complexContent>
...
@XmlType(name = "purchaseProtocolEvasionKESMBODataType", propOrder = {
    "procedureDate",
    "procedurePlace",
    "protocolSignDate",
    "commissionNumber",
...
public class PurchaseProtocolEvasionKESMBODataType
