...
/**
 * Протокол отказа от заключения договора запроса котировок в электронной форме, участниками которого могут являться только субъекты малого и среднего предпринимательства
 * 
...
@XmlType(name = "purchaseProtocolRejectionZKESMBODataType", propOrder = {
    "procedureDate",
    "procedurePlace",
    "protocolSignDate",
    "commissionNumber",
