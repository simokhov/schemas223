...
/**
 * Протокол отказа от заключения договора аукциона в электронной форме, участниками которого могут являться только субъекты малого и среднего предпринимательства
 * 
 * <p>Java class for purchaseProtocolRejectionZPESMBODataType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="purchaseProtocolRejectionZPESMBODataType">
 *   &lt;complexContent>
...
@XmlType(name = "purchaseProtocolRejectionZPESMBODataType", propOrder = {
    "procedureDate",
    "procedurePlace",
    "protocolSignDate",
    "commissionNumber",
...
public class PurchaseProtocolRejectionZPESMBODataType
