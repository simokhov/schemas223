...
/**
 * Протокол признания участника уклонившимся от заключения договора аукциона в электронной форме, участниками которого могут являться только субъекты малого и среднего предпринимательства
 * 
 * <p>Java class for purchaseProtocolEvasionZPESMBODataType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="purchaseProtocolEvasionZPESMBODataType">
 *   &lt;complexContent>
...
@XmlType(name = "purchaseProtocolEvasionZPESMBODataType", propOrder = {
    "procedureDate",
    "procedurePlace",
    "protocolSignDate",
    "commissionNumber",
...
public class PurchaseProtocolEvasionZPESMBODataType
