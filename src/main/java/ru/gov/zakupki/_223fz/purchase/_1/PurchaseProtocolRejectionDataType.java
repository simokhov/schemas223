...
/**
 * Протокол отказа от заключения договора (для конкурса, аукциона, запроса котировок или предложений в электронной форме, участниками которого могут являться только субъекты малого и среднего предпринимательства)
 * 
 ...
 *         &lt;element name="application" type="{http://zakupki.gov.ru/223fz/purchase/1}protocolSearchApplicationType"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlSeeAlso({
    PurchaseProtocolRejectionKESMBODataType.class
})
    ...
    extends PurchaseProtocolBaseDataType
{
    ...
    @XmlElement(required = true)
    protected ProtocolSearchApplicationType application;
     ...
     * @return
     *     possible object is
     *     {@link ProtocolSearchApplicationType }
     *     
     */
    public ProtocolSearchApplicationType getApplication() {
        return application;
    }
     ...
     *     
     */
    public void setApplication(ProtocolSearchApplicationType value) {
