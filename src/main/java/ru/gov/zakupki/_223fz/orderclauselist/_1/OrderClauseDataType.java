 ...
 *                   &lt;element name="termOfContractConclusion" type="{http://www.w3.org/2001/XMLSchema}date" minOccurs="0"/>
...
public class OrderClauseDataType {
    ...
    public static class TypalOrderInfo {
        ...
        @XmlSchemaType(name = "date")
        protected XMLGregorianCalendar termOfContractConclusion;
         ...
         *     
         */
        public XMLGregorianCalendar getTermOfContractConclusion() {
         ...
         *     
         */
        public void setTermOfContractConclusion(XMLGregorianCalendar value) {
