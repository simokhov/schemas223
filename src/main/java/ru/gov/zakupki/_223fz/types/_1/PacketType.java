...
import ru.gov.zakupki._223fz.agencyrelation._1.NsiAgencyRelations;
...
import ru.gov.zakupki._223fz.contract._1.ElectronicContract;
import ru.gov.zakupki._223fz.contract._1.PerformanceContract;
import ru.gov.zakupki._223fz.contract._1.SubcontractorInfo;
import ru.gov.zakupki._223fz.customerregistry._1.NsiCustomer;
...
import ru.gov.zakupki._223fz.purchase._1.PurchaseProtocolCCAESMBO;
import ru.gov.zakupki._223fz.purchase._1.PurchaseProtocolCCKESMBO;
import ru.gov.zakupki._223fz.purchase._1.PurchaseProtocolCCZKESMBO;
import ru.gov.zakupki._223fz.purchase._1.PurchaseProtocolCCZPESMBO;
import ru.gov.zakupki._223fz.purchase._1.PurchaseProtocolCollationAESMBO;
import ru.gov.zakupki._223fz.purchase._1.PurchaseProtocolEvasionAESMBO;
import ru.gov.zakupki._223fz.purchase._1.PurchaseProtocolEvasionKESMBO;
import ru.gov.zakupki._223fz.purchase._1.PurchaseProtocolEvasionZKESMBO;
import ru.gov.zakupki._223fz.purchase._1.PurchaseProtocolEvasionZPESMBO;
import ru.gov.zakupki._223fz.purchase._1.PurchaseProtocolFCDKESMBO;
import ru.gov.zakupki._223fz.purchase._1.PurchaseProtocolFCODKESMBO;
import ru.gov.zakupki._223fz.purchase._1.PurchaseProtocolFKVOKESMBO;
...
import ru.gov.zakupki._223fz.purchase._1.PurchaseProtocolRZ1AESMBO;
import ru.gov.zakupki._223fz.purchase._1.PurchaseProtocolRZ1KESMBO;
import ru.gov.zakupki._223fz.purchase._1.PurchaseProtocolRZ1ZPESMBO;
import ru.gov.zakupki._223fz.purchase._1.PurchaseProtocolRZ2AE;
import ru.gov.zakupki._223fz.purchase._1.PurchaseProtocolRZ2AESMBO;
import ru.gov.zakupki._223fz.purchase._1.PurchaseProtocolRZ2KESMBO;
import ru.gov.zakupki._223fz.purchase._1.PurchaseProtocolRZ2ZPESMBO;
...
import ru.gov.zakupki._223fz.purchase._1.PurchaseProtocolRZZKESMBO;
import ru.gov.zakupki._223fz.purchase._1.PurchaseProtocolRejectionAESMBO;
import ru.gov.zakupki._223fz.purchase._1.PurchaseProtocolRejectionKESMBO;
import ru.gov.zakupki._223fz.purchase._1.PurchaseProtocolRejectionZKESMBO;
import ru.gov.zakupki._223fz.purchase._1.PurchaseProtocolRejectionZPESMBO;
import ru.gov.zakupki._223fz.purchase._1.PurchaseProtocolSummingupAESMBO;
import ru.gov.zakupki._223fz.purchase._1.PurchaseProtocolSummingupKESMBO;
import ru.gov.zakupki._223fz.purchase._1.PurchaseProtocolSummingupZKESMBO;
import ru.gov.zakupki._223fz.purchase._1.PurchaseProtocolSummingupZPESMBO;
import ru.gov.zakupki._223fz.purchase._1.PurchaseProtocolVK;
import ru.gov.zakupki._223fz.purchase._1.PurchaseProtocolZK;
import ru.gov.zakupki._223fz.purchase._1.PurchaseProtocolZRPZAESMBO;
import ru.gov.zakupki._223fz.purchase._1.PurchaseProtocolZRPZKESMBO;
import ru.gov.zakupki._223fz.purchase._1.PurchaseProtocolZRPZZKESMBO;
import ru.gov.zakupki._223fz.purchase._1.PurchaseProtocolZRPZZPESMBO;
...
import ru.gov.zakupki._223fz.webrequest._1.ConfirmationDataResponse;
...
import ru.gov.zakupki._223fz.webrequest._1.TicketsDataResponse;
...
@XmlSeeAlso({
    TicketsDataResponse.class,
    ConfirmationDataResponse.class,
    ...
    PurchaseProtocolRZ1ZPESMBO.class,
    ListGWS.class,
    PurchaseNoticeZPESMBO.class,
    PurchaseProtocolRZ2AESMBO.class,
    PurchaseProtocolEvasionKESMBO.class,
    PurchaseNoticeZKESMBO.class,
    PurchaseProtocolEvasionZPESMBO.class,
    PurchaseProtocolRZ2AE.class,
    PurchaseNoticeOK.class,
    VolumeMonitoring.class,
    PurchaseProtocolZRPZAESMBO.class,
    PurchaseProtocolPAAE.class,
    ExplanationRequest.class,
    PurchaseProtocolCCZKESMBO.class,
    PurchaseProtocolRZ1AESMBO.class,
    ProtocolCancellation.class,
    PurchaseProtocolRZAE.class,
    PurchaseProtocolSummingupKESMBO.class,
    PurchaseProtocolZK.class,
    PurchaseContract.class,
    PurchaseProtocolZRPZZPESMBO.class,
    PurchaseProtocolPAOA.class,
    PurchaseProtocolRejectionAESMBO.class,
    PurchaseProtocolRZ2KESMBO.class,
    PurchaseProtocolVK.class,
    PurchaseProtocolOSZ.class,
    PurchaseProtocolZRPZKESMBO.class,
    PurchaseProtocolEvasionZKESMBO.class,
    PurchaseRejection.class,
    ChangeRequirements.class,
    ProtocolLotAllocation.class,
    PurchaseProtocolZRPZZKESMBO.class,
    PurchaseProtocolFCODKESMBO.class,
    PurchaseProtocolCCZPESMBO.class,
    PurchaseProtocolRZ2ZPESMBO.class,
    ...
    PurchaseProtocolSummingupZPESMBO.class,
    PurchaseProtocolCollationAESMBO.class,
    PurchaseProtocolRejectionZPESMBO.class,
    PurchaseNoticeAE94FZ.class,
    PurchaseProtocolRZ1AE.class,
    PurchaseProtocolRZOA.class,
    VolumeInnovPurchase.class,
    PurchaseProtocolCCAESMBO.class,
    PurchaseNotice.class,
    PurchaseNoticeZK.class,
    PurchaseNoticeEP.class,
    PurchaseProtocolCCKESMBO.class,
    PurchaseProtocolRejectionZKESMBO.class,
    Explanation.class,
    PurchaseProtocolSummingupZKESMBO.class,
    PurchaseProtocolFCDKESMBO.class,
    PurchaseProtocolRZ1KESMBO.class,
    PurchaseProtocolRejectionKESMBO.class,
    PurchaseProtocolSummingupAESMBO.class,
    PurchaseProtocolRZZKESMBO.class,
    PurchaseProtocolFKVOKESMBO.class,
    PurchaseProtocol.class,
    PurchaseContractAccount.class,
    PurchaseProtocolEvasionAESMBO.class,
    EcpPacket.class,
